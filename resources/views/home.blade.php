        ...
        <header class="navbar navbar-expand-md d-print-none">
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href=".">
                        <img src="/img/jobco.png" width="110" height="32" alt="JobCo"
                  ...
                  <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                    ...
                    <div class="nav-item dropdown">
                        <span class="d-none d-sm-inline">
                            <a href="/sign-up" class="btn text-dark"
                                style="background-color: #ffffff; border-color: #625D9E; border-width: 1.5px; border-radius: 9px">
                                Sign Up
                            </a>
                        </span>
                    </div>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-body">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card-table table-responsive">
                      <table class="table table-vcenter">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active ">
                                    <div class="row justify-content-center">
                                        <div class="" style="flex: 0 0 27.72%; max-width: 27.72%;">
                                            <div class="card ">
                                                <div class="card-body">
                                                    <div class="testimonial-content">
                                                        <div class="testimonial-quote">
                                                            <p>Seneng banget bisa belajar di JobCo! Pembelajarannya
                                                                asik, materinya pun daging semua. Ga nyesel bisa belajar
                                                                dan kenal mentor-mentor keren dari JobCo!</p>
                                                        </div>
                                                    ...
                                                    <div class="testimonial-image"
                                                        ...
                                                        <img src="/static/avatars/000f.jpg" height="45"
                                                            width="45" alt="Christoper Nolance">
                                                    </div>
                                                </div>
                                                <!-- card content -->
                                            </div>
                                        ...
                                        <div class="" style="flex: 0 0 27.72%; max-width: 27.72%;">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="testimonial-image"
                                                        style="margin-left: 210px; margin-top: -40px">
                                                        <img src="/static/avatars/000m.jpg" height="45"
                                                            width="45" alt="Christoper Nolance">
                                                    </div>
                                                </div>
                                                <!-- card content -->
                                        ...
                                        <div class="" style="flex: 0 0 27.72%; max-width: 27.72%;">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="testimonial-image"
                                                        style="margin-left: 210px; margin-top: -40px">
                                                        <img src="/static/avatars/001f.jpg" height="45"
                                                            width="45" alt="Christoper Nolance">
                                                    </div>
                                                </div>
                                                <!-- card content -->
                                        ...
                                        <div class="" style="flex: 0 0 27.72%; max-width: 27.72%;">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="testimonial-image"
                                                        style="margin-left: 210px; margin-top: -40px">
                                                        <img src="/static/avatars/001m.jpg" height="45"
                                                            width="45" alt="Christoper Nolance">
                                                    </div>
                                                </div>
                                                <!-- card content -->
                                        ...
                                        <div class="" style="flex: 0 0 27.72%; max-width: 27.72%;">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="testimonial-image"
                                                        style="margin-left: 210px; margin-top: -40px">
                                                        <img src="/static/avatars/002f.jpg" height="45"
                                                            width="45" alt="Christoper Nolance">
                                                    </div>
                                                </div>
                                                <!-- card content -->
                                        ...
                                        <div class="" style="flex: 0 0 27.72%; max-width: 27.72%;">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="testimonial-image"
                                                        style="margin-left: 210px; margin-top: -40px">
                                                        <img src="/static/avatars/002m.jpg" height="45"
                                                            width="45" alt="Christoper Nolance">
                                                    </div>
                                                </div>
                                                <!-- card content -->
                        ...
                        <div class="col-8" style="margin-left: 20rem">
                            <img src="/img/image 16.png" alt="Image" class="me-3 mt-5"
                            ...
                            <div class="card-body ms-auto">
                                ...
                                <div class="row mt-4">
                                    <div class="col-1">
                                        <input class="form-check-input" style="background-color: #433D8B"
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <a href="#" class="btn btn-sm text-light rounded"
                                            style="background-color: #625D9E">Lihat Selengkapnya</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-10">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <img src="/img/image 17.png" width="200" height="200" class="img-fluid"
                                            alt="Discuss Room Image">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-8" style="margin-left: 20rem">
                            <img src="/img/image 18.png" alt="Image" class="me-3 mt-5"
                                style="width: 200px; height: 200px;">
                            {{-- <div class="card-stamp card-stamp-lg ms-auto">
                              <div class="card-stamp-icon bg-primary">
                                  <!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
                  ...
                  <div id="myCardCarousel" class="carousel slide" data-bs-ride="carousel">
                      <!-- Slides -->
                      <div class="carousel-inner">
                          <div class="carousel-item active">
                              <div class="card">
                          ...
                          <!-- Tambahkan lebih banyak slide dengan card sesuai kebutuhan -->
                      </div>
              
                      <!-- Controls -->
                      <a class="carousel-control-prev" href="#myCardCarousel" role="button" data-bs-slide="prev">
                          <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                          <span class="visually-hidden">Previous</span>
                      </a>
                      <a class="carousel-control-next" href="#myCardCarousel" role="button" data-bs-slide="next">
                          <span class="carousel-control-next-icon" aria-hidden="true"></span>
                          <span class="visually-hidden">Next</span>
                      </a>
                  </div>
